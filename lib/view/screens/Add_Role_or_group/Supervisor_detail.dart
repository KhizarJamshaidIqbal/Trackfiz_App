...
import 'Manager_detail.dart';
import 'Select_Employee.dart';

class Supervisordetail extends StatefulWidget {
  const Supervisordetail({super.key});

  @override
  State<Supervisordetail> createState() => _SupervisordetailState();
}

class _SupervisordetailState extends State<Supervisordetail> {
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 4.0),
                        child: CustomSwitch(
                          title: 'Clock in other employees',
                          subtitle: '',
                          value: isSwitched,
                          onChanged: (value) {
                            setState(() {
